...
def test_user_registration(opencart_page):
    ...
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_email']", "kosegarov@yandex.ru")
    ...
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_firstname']", "Andrey")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_lastname']", "Kochegarov")
